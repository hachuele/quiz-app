    ...
    <div id="dash_compl_ip_row_div" class="row" style="margin:auto;">
            ...
            <div id="completed_quizzes_dash_div" class="dashboard_element_card">
                ...
                <div class="completed_quizzes_list">
                    <table class="table table-hover compl_quizzes_tbl">
                        ...
                        <tbody>
                            <?php foreach($completed_quizz_unique_array as $completed_quizz){ ?>
                            <tr>
                                <?php
        ...
        <div class=" col-sm-6" style="margin-top: 15px;">
            <div id="available_quizzes_dash_div" class="dashboard_element_card">
                <div class="dash_card_title_div">
                    <h4>AVAILABLE &amp; IN-PROGRESS QUIZZES <span class="glyphicon glyphicon-education blue_darken_2"></span></h4>
                    <hr>
                </div>
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <button type="button" class="btn btn-grey-lighten btn-sm" onclick="location.href='<?php echo url_for('quizz/index.php?assessment_id=' . h(u($ip_quizz['assessment_id']))); ?>'">
